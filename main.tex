...
\zahvala{To my family, for the perpetual support and patience. \\ Mojoj obitelji, za ustrajnu podršku i strpljenje.}
...
\begin{abstract}
A distributed temperature sensing systems is implemented and described. The system is based on optical time-domain reflectometry, and Raman non-linear scattering effect. The basic theory of optical fibres and their application in communication systems is described, along with significant linear and non-linear fibre-optical effects. Two reflectometric methods for characterizing optical fibres are explained. The implemented system is thoroughly described, calibrated and tested. Results obtained using two different laboratory setups, based on single-mode and multi-mode fibres, are presented. Sensor system performance is discussed, and methods for future enhancements are suggested.

\keywords{Distributed temperature sensor system, Fibre-optical sensor, Optical time-domain reflectometry, Raman scattering, Brilloiun scattering}
\end{abstract}

\begin{sazetak}
Implementiran je i opisan senzorski sustav za distribuirano mjerenje temperature. Sustav se zasniva na metodi optičke reflektometrije u vremenskoj domeni i efektu Ramanovog nelinearnog raspršenja. Opisane su osnove teorije svjetlovoda i njihove primjene u komunikacijskim sustavima, kao i značajni linearni i nelinearni efekti u svjetlovodima. Objašnjene su dvije reflektometrijske metode za karakterizaciju svjetlovoda. Implementirani sustav je potanko opisan, kalibriran i ispitan. Predstavljeni su rezultati dobiveni dvama mjernim postavima, zasnovanima na jednomodnim i višemodnim svjetlovodima. Raspravljena su svojstva senzorskog sustava, a predložene su i metode za daljnju nadogradnju.

\kljucnerijeci{Distribuirani svjetlovodni senzorski sustav, Svjetlovodni senzor, Optički reflektometar u vremenskoj domeni, Ramanovo raspršenje, Brillouinovo raspršenje}
\end{sazetak}
