...
The loss introduced by Rayleigh scattering is manifested by a slope in the measured profile. Fibre attenuation can be easily retrieved by determining the slope. Other anomalies of the fibre can be observed, such as splicing and connector losses, reflections off fibre ends, etc. All the losses at different points in the measured fibre can be numerically measured on the oscilloscope screen.\\
